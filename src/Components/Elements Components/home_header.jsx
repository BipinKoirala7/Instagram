...
export default memo(function Header_home(){
    return(
        <div className="col-start-1 col-end-4 row-start-1 row-end-1 flex justify-center items-center w-[100%] px-4 py-0">
            <p className="mr-auto text-[2em] font-lobsterone">Instagram</p>
            <button className="w-16 aspect-square flex justify-center items-center hover:bg-[rgb(43,41,41)] rounded-[50%]">
                <svg className="h-9 stroke-white stroke-2 fill-transparent" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	            viewBox="0 0 56.69 56.69" enableBackground="new 0 0 56.69 56.69" xmlSpace="preserve">
