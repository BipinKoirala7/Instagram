...
export default memo(function Header_home(){
    return(
        <div className="sticky bg-black top-0 col-start-1 col-end-4 row-start-1 row-end-1 flex justify-center items-center w-[100%] px-4">
            <p className="mr-auto text-[1.7em] font-lobsterone">Instagram</p>
            <button className="w-12 aspect-square flex justify-center items-center hover:bg-[rgb(43,41,41)] rounded-[50%]">
                <svg className="h-6 stroke-white stroke-2 fill-transparent" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
